...
class LCD12864_SPI( FrameBuffer ):
    def __init__( self, spi, cs_pin, rst_pin = None, rotation = 0 ):
        ...
        self.buffer = bytearray( LCD_WIDTH * LCD_HEIGHT // 8 )
    ...
    @micropython.viper 
    def draw_bitmap(self, bitmap, x:int, y:int, color:int = 1):
    ...
    def show( self ):
        ...
        buffsize = LCD_WIDTH * LCD_HEIGHT // 8
        rotation = int(self._rotation)
        buffer = ptr8( self.buffer )
        row_buffer = bytearray( 16 * 3 )
        row_ptr = ptr8(row_buffer)
        ...
        for y in range(64):
            ...
            for x in range(16):
                ...
                x_offset = x * 3
                row_ptr[ x_offset     ] = LCD_DATA 
                row_ptr[ x_offset + 1 ] = data & 0xF0
                row_ptr[ x_offset + 2 ] = (data & 0x0F) << 4
